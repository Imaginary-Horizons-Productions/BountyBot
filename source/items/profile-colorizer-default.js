...
module.exports = new Item(itemName, "Changes the color of your stats profile embed to black",
	...
	(interaction, database) => {
		...
		interaction.reply({ content: `Your profile color has been set to black in this server.`, ephemeral: true });
	}
);
