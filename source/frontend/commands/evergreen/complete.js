			...
			collector.on("collect", async collectedInteraction => {
				...
				switch (stepId) {
					...
					case "hunters":
						...
						const completedBountyEmbed = await buildBountyEmbed(bounty, collectedInteraction.guild, currentCompanyLevel, false, company, finalContributorIds);
						...
						if (company.bountyBoardId) {
							...
							const bountyBoard = await collectedInteraction.guild.channels.fetch(company.bountyBoardId);
							updateEvergreenBountyBoard(bountyBoard, evergreenBounties, company, currentCompanyLevel, collectedInteraction.guild, hunterIdMap);
