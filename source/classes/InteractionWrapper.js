...
class ButtonWrapper extends InteractionWrapper {
	 ...
	 * @param {string} mainIdInput
	 * @param {number} cooldownInMS
	 * @param {(interaction: ButtonInteraction, args: string[], runMode: "development" | "test" | "production") => void} executeFunction
	 */
	constructor(mainIdInput, cooldownInMS, executeFunction) {
...
class SubcommandWrapper {
	 ...
	 * @param {string} descriptionInput
	 * @param {(interaction: CommandInteraction, runMode: string, ...args: [typeof import("../logic"), unknown]) => Promise<void>} executeFunction
	 */
...
class SelectWrapper extends InteractionWrapper {
	 ...
	 * @param {string} mainIdInput
	 * @param {number} cooldownInMS
	 * @param {(interaction: AnySelectMenuInteraction, args: string[], runMode: "development" | "test" | "production") => void} executeFunction
	 */
	constructor(mainIdInput, cooldownInMS, executeFunction) {
		super(mainIdInput, cooldownInMS, executeFunction);
	}
